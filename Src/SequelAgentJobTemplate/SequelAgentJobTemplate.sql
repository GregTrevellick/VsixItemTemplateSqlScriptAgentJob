...
SET 
  @command = N 'EXEC HadesProcess_ProcessAll';
SET 
  @stepId = 2;
SET 
  @stepName = N 'HadesProcess_ProcessAll';
IF (
  dbo.fnDoesJobStepExist(@jobName, @stepId) = 0
) BEGIN EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId, 
@step_id = @stepId, 
...
SET 
  @command = N 'EXEC HadesProcess_ICActivityMonitorTransactions;';
SET 
  @stepId = 3;
SET 
  @stepName = N 'HadesProcess_ICActivityMonitorTransactions';
IF (
  dbo.fnDoesJobStepExist(@jobName, @stepId) = 0
) BEGIN EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId, 
@step_id = @stepId, 
...
SET 
  @command = N 'EXEC HadesProcess_ICActivityMonitor';
SET 
  @stepId = 4;
SET 
  @stepName = N 'HadesProcess_ICActivityMonitor';
IF (
  dbo.fnDoesJobStepExist(@jobName, @stepId) = 0
) BEGIN EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId, 
@step_id = @stepId, 
...
SET 
  @command = N 'EXEC dbo.InsertOutboundTransactionLog;';
SET 
  @stepId = 5;
SET 
  @stepName = N 'InsertOutboundTransactionLog';
IF (
  dbo.fnDoesJobStepExist(@jobName, @stepId) = 0
) BEGIN EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId, 
@step_id = @stepId, 
...
SET 
  @command = N 'EXEC CalculateFinancialStates';
SET 
  @stepId = 6;
SET 
  @stepName = N 'CalculateFinancialStates';
IF (
  dbo.fnDoesJobStepExist(@jobName, @stepId) = 0
) BEGIN EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId, 
@step_id = @stepId, 
